[[iaan-01-Introduction.pdf]]

> **Das Gehirn**
> - Volumen: 1,3l
> - Gewicht: 1,5kg
> - Verbraucht 20% der Energie im Körper
> - $1.2\cdot 10^{11}$ Neuronen, $10^{14}$ Verbindungen

## Nervensystem
Teilt sich ein in *zentrales* und *peripheres* Nervensystem
...
- alles andere(?)
- Neuronen und Nerven, die sich durch den gesamten Körper ziehen und nicht durch Knochen geschützt sind
- Somatisches Nervensystem
	- regt Haut, Muskeln und Gelenke an
	- verantwortlich für Übertragungen von Sensorik-Stimuli und bewusste Bewegungen
- Autonomes Nervensystem
	- Für Drüsen und innere Organe, ohne bewusste Kontrolle

## Achsen zur Orientierung im Gehirn
...
Es gibt noch die Achse von Stirn nach Rückenmark. Die ist gekrümmt, weil wir einen aufrechten Gang haben. Richtung Stirn heißt *rostral*, richtung Rückenmark heißt *caudal*. Oberhalb dieser Achse heißt *dorsal*, unterhalb heißt *ventral*.

![[Schädel.png|300]]

Bildachsen in MRT-Bildern: 
- Sagittal (fehlt links/rechts)
- Coronal (fehlt vorne/hinten)
- Transverse/horizontal (fehlt oben/unten)

![[Körperachsen.png|300]]

## Anatomie
Wir haben die linke und die rechte Hemisphäre. Die Verbindung dazwischen, in der Mitte des Gehrins, ist das *Corpus Callosum*.

- Großhirn (Cerebrum)
- Kleinhirn (Cerebellum)
- Hirnstamm, bestehend aus
	- Mittelhirn
	- Brücke (Pons)
	- Markhirn (Medulla)
...
Besteht aus:
- Großhirnrinde (Cerebral Cortex)
- Hippocampus
	- beidseitig
	- seepferdchengroß
	- wichtig für Überführung vom Kurzzeit- ins Langzeitgedächtnis
- Amygdala
	- zwei kleine Mandeln
...
> Stark zusammengefaltet mit Erhebungen (Gyri) und Falten (Sulci).
> Etwa 2-4mm dick und auseinandergefaltet so groß wie 4 A4-Blätter.
> 
> Besteht aus sechs Schichten, selten weniger.
...
- Wernicke-Areal (Brodmann 22): Sprache verstehen
	- Schädigung: Opfer kann nur noch Kauderwelsch sprechen, keine Geräusche mehr ihren Quellen zuordnen, u.ä.
